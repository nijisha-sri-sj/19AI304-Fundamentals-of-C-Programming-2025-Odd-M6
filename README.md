...
```
# Output:
<img width="1266" height="656" alt="Screenshot 2026-06-04 105724" src="https://github.com/user-attachments/assets/2f3daf86-ab95-4533-8d18-fd3e720d0d58" />
...
```
# Output:
<img width="1344" height="814" alt="Screenshot 2026-06-04 105822" src="https://github.com/user-attachments/assets/249b18fe-b230-4cc3-a323-fea609ad7218" />
...
```
# Output:
<img width="1343" height="771" alt="Screenshot 2026-06-04 110018" src="https://github.com/user-attachments/assets/9da769fa-5490-4e85-8d72-874e97acdc3b" />
...
int main(){
    struct date person ={
        22, 5, 2026,    /* Current Date */
        15, 8, 2000,    /* Birth Date */
        0, 0, 0
    };
    struct date *result;
    result = findAge(&person);
    printf("Present Age:\n");
...
```
# Output:
<img width="1286" height="754" alt="Screenshot 2026-06-04 110054" src="https://github.com/user-attachments/assets/d68733a2-b7bb-4735-9dc3-3f048c38cf7f" />
...
```
# Output:
<img width="1275" height="600" alt="Screenshot 2026-06-04 110123" src="https://github.com/user-attachments/assets/51a0cd24-fb64-4df1-bb79-cbf6e3fb5dcd" />
